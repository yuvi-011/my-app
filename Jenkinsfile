node{
   ...
   sh "docker login -u admin -p ${nexusPassword} 3.8.163.135:8083"
   }
   sh "docker tag yuvarajeleven/myweb:0.0.2 3.8.163.135:8083/yuvi:1.0.0"
   sh 'docker push 3.8.163.135:8083/yuvi:1.0.0'
   }
